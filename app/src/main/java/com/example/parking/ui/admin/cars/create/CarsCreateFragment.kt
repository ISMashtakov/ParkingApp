...
class CarsCreateFragment : Fragment() {

    companion object {
        fun newInstance() = CarsCreateFragment()
    }

    private val viewModel by viewModel<CarsCreateViewModel>()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.cars_create_fragment, container, false)
    }
    ...
    private fun subscribeOnCreateButton(view: View) {
        ...
        val numberText: TextInputEditText = view.findViewById(R.id.numberTextInput)
        val modelText: TextInputEditText = view.findViewById(R.id.modelTextInput)
        val lengthText: TextInputEditText = view.findViewById(R.id.lengthTextInput)
        val weightText: TextInputEditText = view.findViewById(R.id.weightTextInput)
        ...
        try {
            backButton.setOnClickListener {
                viewModel.createCar(
                    ...
                    lengthText.text.toString().toInt(),
